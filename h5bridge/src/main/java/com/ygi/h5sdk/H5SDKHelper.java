...
import com.ygi.h5sdk.impl.BannerCallback;
import com.ygi.h5sdk.impl.DefaultWebChromeClient;
import com.ygi.h5sdk.impl.DefaultWebViewClient;
import com.ygi.h5sdk.impl.OnBackPressedDelegate;
import com.ygi.h5sdk.impl.ygiJsBridge;
import com.ygi.h5sdk.impl.ygiJsCallAppProcessor;
import com.ygi.h5sdk.js.BaseBridge;
import com.ygi.h5sdk.js.WebChromeClientDelegate;
import com.ygi.h5sdk.js.WebViewClientDelegate;

import java.lang.ref.WeakReference;

public class H5SDKHelper implements OnBackPressedDelegate, WebViewClientDelegate, WebChromeClientDelegate {

    private ygiJsCallAppProcessor processor;
    ...
    private void init(final WebView webView) {
        ...
        ygiJsBridge bridge = new ygiJsBridge(webView, processor);
