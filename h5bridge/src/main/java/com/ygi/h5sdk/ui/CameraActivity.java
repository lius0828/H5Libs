                ...
                if (cameraView.isCameraOpened()) {
                    if (isVideoRecord) {
                        if (!cameraView.isRecordering()) {
                            ...
                            CamcorderProfile camcorderProfile = CameraHelper.chooseOptimalCamcorderProfile(cameraView.getCameraId(), 480, 360);
